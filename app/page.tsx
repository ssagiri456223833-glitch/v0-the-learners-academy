        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="page-title text-[48px] md:text-[64px] font-medium text-foreground leading-tight tracking-tight">
              The Learners <span className="text-primary italic">Academy</span>
            </h1>
          ...
          <Link href="/admin">
            <Card className="border border-border bg-white rounded-lg transition-all duration-300 hover:shadow-md h-full overflow-hidden">
              <CardContent className="p-10 flex flex-col items-center text-center space-y-6">
                ...
                <div>
                  <h2 className="text-[20px] font-semibold text-foreground italic">Institutional Admin</h2>
                  <p className="label-text mt-2 uppercase tracking-wide opacity-70">Term Cycle & Staff Hub</p>
                </div>
          ...
          <Link href="/teacher">
            <Card className="border border-border bg-white rounded-lg transition-all duration-300 hover:shadow-md h-full overflow-hidden">
              <CardContent className="p-10 flex flex-col items-center text-center space-y-6">
                ...
                <div>
                  <h2 className="text-[20px] font-semibold text-foreground italic">Assessor Portal</h2>
          ...
          <Link href="/student">
            <Card className="border border-border bg-white rounded-lg transition-all duration-300 hover:shadow-md h-full overflow-hidden">
              <CardContent className="p-10 flex flex-col items-center text-center space-y-6">
                ...
                <div>
                  <h2 className="text-[20px] font-semibold text-foreground italic">Student Access</h2>
                  <p className="label-text mt-2 uppercase tracking-wide opacity-70">On-Site Evaluation</p>
                </div>
